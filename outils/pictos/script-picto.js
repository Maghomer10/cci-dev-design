...
$(document).ready(function () {
	$("i[picto]").each(function () {  
		...
		$(this).load(
			pictoURL,
			function(){
				$(this).children().addClass(pictoCouleur);
				$('svg defs style').replaceWith(StyleColorExport);
				if(pictoTaille !== null){
					$(this).children().attr('width', pictoTaille);
					$(this).children().attr('height', 'auto');
				}
			});
	});
});
